...
grid space height:soil_height width:soil_width neighbors:8 skills:[conflict_resolverV2]{
	...
	init{
		nb_conflict <- 0;		
		do define_coordinator_function parameter:"raw_OM" no_coordination:true;
		do define_coordinator_function parameter:"soluble_OM" no_coordination:true;
		do define_coordinator_function parameter:"decomp_OM" no_coordination:true;
		do define_coordinator_function parameter:"soluble_MM" no_coordination:true;
